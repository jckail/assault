...
class Results:
    ...
    def average_time(self) -> float:
        ...
        3.513333333333333
        """
        return mean([r['request_time'] for r in self.requests]) #pass list to mean_function
    ...
    def successful_requests(self) -> int:
        ...
        2
        """
        return len([r for r in self.requests if r['status_code'] in range(200,299)]) #pass list to mean_function
